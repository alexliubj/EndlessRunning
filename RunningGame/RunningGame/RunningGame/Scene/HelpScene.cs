...
namespace RunningGame.Scene
{
    ...
    /// </summary>
    public class HelpScene : DrawableGameComponent
    {
        Game gameObject;
        ...
        Texture2D[] backgroundTexture = new Texture2D[4];
        ...
        public override void Initialize()
        {
            ...
            button_rectangle[0] = new Rectangle(30, 30, BUTTON_WIDTH, BUTTON_HEIGHT);
            button_rectangle[1] = new Rectangle(20, Game.Window.ClientBounds.Height / 2, BUTTON_WIDTH, BUTTON_HEIGHT);
            button_rectangle[2] = new Rectangle(Game.Window.ClientBounds.Width - 20 - BUTTON_WIDTH, Game.Window.ClientBounds.Height / 2, BUTTON_WIDTH, BUTTON_HEIGHT);
